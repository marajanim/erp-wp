...
@media print{.print-bar{display:none;}body{background:#fff;padding:12mm;margin:0;}html{background:#fff;}.invoice-box{max-width:100%;margin:0;padding:0;border:none;box-shadow:none;}}
</style>
</head>
<body>
